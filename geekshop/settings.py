...
SECRET_KEY = 'i(7e(*!9tti!7ymj3_k*sw60(^^l*_n3@0w%bkq!x0z9zdwng'
...
SOCIAL_AUTH_VK_OAUTH2_KEY = SOCIAL.get('VK_OAUTH2', '').\
    get('SOCIAL_AUTH_VK_OAUTH2_KEY', '')
SOCIAL_AUTH_VK_OAUTH2_SECRET = SOCIAL.get('VK_OAUTH2', '').\
    get('SOCIAL_AUTH_VK_OAUTH2_SECRET', '')

LOGIN_ERROR_URL = '/'

SOCIAL_AUTH_VK_OAUTH2_IGNORE_DEFAULT_SCOPE = True
SOCIAL_AUTH_VK_OAUTH2_SCOPE = [
    'bdate', 'about', 'sex', 'email'
]
