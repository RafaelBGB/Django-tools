...
urlpatterns = [
    ...
    path('users/update/<int:pk>/', adminapp.AdminUserUpdateView.as_view(), name='user_update'),
    ...
    path('categories/read/', adminapp.CategoryView.as_view(), name='categories'),
    ...
    path('products/read/category/<int:pk>/', adminapp.ProductsCategoryView.as_view(), name='products_category'),
    ...
    path('orders/update/<int:pk>/', adminapp.AdminOrderUpdate.as_view(), name='orders_update'),
    path('orders/delete/<int:pk>/', adminapp.AdminOrderDelete.as_view(), name='orders_delete'),
    path('orders/read/<int:pk>/', adminapp.AdminOrderRead.as_view(), name='orders_read'),
]
